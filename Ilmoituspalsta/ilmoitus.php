<?php
class Ilmoitus {
	// Virhekoodeja vastaavat virheilmoitukset, staattinen lista eli luodaan kerran
	private static $virhelista = array (
            ...
            32 => "Puhelinnumero ei saa olla tyhjä",
            33 => "Puhelinnumero on liian lyhyt/pitkä",
			...
			64 => "Kuvauksessa on kiellettyjä kirjaimia tai merkkejä",
...
//      if (preg_match ( "/[^a-zåäöA-ZÅÄÖ\- ]/", $this->email )) {
//            return 22;
//        }
	...
	public function checkPuhnro($required = true) {
		...
		if (! preg_match ( "/^\+?\d{8,15}$/", $this->puhnro )) {
			return 31;
		}
        return 0;
	}
	...
	public function checkKuvaus($required = true, $min = 3, $max = 1000) {
        ...
        // Jos kuvauksen muoto ei ole oikea
		if (preg_match ( "/[^a-zåäöA-ZÅÄÖ0-9\- ]/", $this->kuvaus )) {
			return 64;
		}
